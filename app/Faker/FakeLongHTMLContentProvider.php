...
class FakeLongHTMLContentProvider extends Base
{
    private function generateTiptapContent(string $baseHtml): string
    {
        ...
        $imageUrl = 'https://loremflickr.com/800/600/' . fake()->word() . ',' . fake()->word() . '?lock=' . fake()->randomNumber(5, true);
        $parts[] = '<figure><img src="' . $imageUrl . '" alt="' . fake()->words(4, true) . '"><figcaption>' . fake()->words(6, true) . '</figcaption></figure>';
