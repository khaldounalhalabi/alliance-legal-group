            ...
            <ul>
                <li>
                    ...
                    <div
                        ...
                        "
                    >
                        {{ trans("site.profound_international_expertise") }}
                    </div>
                    <div
                        class="tp-caption NotGeneric-Title tp-resizeme rs-parallaxlevel-0"
                        id="slide-1-layer-6"
                        ...
                        "
                    >
                        {{ trans("site.profound_international_expertise_description") }}
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div
                        ...
                        "
                    >
                        {{ trans("site.tailored_legal_solutions") }}
                    </div>
                    <div
                        class="tp-caption NotGeneric-Title tp-resizeme rs-parallaxlevel-0"
                        id="slide-2-layer-4"
                        ...
                        "
                    >
                        {{ trans("site.tailored_legal_solutions_description") }}
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div
                        ...
                        "
                    >
                        {{ trans("site.comprehensive_transition_and_compliance_support") }}
                    </div>
                    <div
                        class="tp-caption NotGeneric-Title tp-resizeme rs-parallaxlevel-0"
                        id="slide-3-layer-2"
                        ...
                        "
                    >
                        {{ trans("site.comprehensive_transition_and_compliance_support_description") }}
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div
                        ...
                        "
                    >
                        {{ trans("site.proactive_and_practical_legal_advice") }}
                    </div>
                    <div
                        class="tp-caption NotGeneric-Title tp-resizeme rs-parallaxlevel-0"
                        id="slide-4-layer-2"
